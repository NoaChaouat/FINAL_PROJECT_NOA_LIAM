...
public enum UserMessage {
    ...
    UPDATE_COMMITTEE_CHAIR_FAIL_NOT_IN_COMMITTEE("Unable to update committee chair. The lecturer you specified is not a member of the committee."),
    ...
    ADD_LECTURER_TO_DEPARTMENT_FAIL_ALREADY_IN_DEPARTMENT("Lecturer is already part of the department."),
